...
public interface ControllerInterface extends Remote {
    ...
    boolean deleteitems(items item)throws RemoteException;
    boolean checkout(items item)throws RemoteException;
    boolean check_in(items item)throws RemoteException;
